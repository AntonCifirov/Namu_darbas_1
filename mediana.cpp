...
duom ivedimas() {
    ...
    int size = asmuo.paz.size();
    asmuo.median = findMedian(asmuo.paz, size);
...
void isvedimas(duom temp) {
    ...
    string gal_tab(9-int_length(temp.gal), ' ');
    ...
    cout<<"|"<<setprecision(3)<<temp.gal<<gal_tab;
    cout<<"|"<<setprecision(3)<<temp.median<<gal_tab;
